            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('add_admin') }}">
                        ...
                        <div class="form-group row">
                            <label for="autobio" class="col-md-4 col-form-label text-md-right">{{ __('About you') }}</label>

                            <div class="col-md-6">
                                <textarea id="autobio" class="form-control{{ $errors->has('autobio') ? ' is-invalid' : '' }}" name="autobio">
                                </textarea
                                @if ($errors->has('autobio'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('autobio') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
